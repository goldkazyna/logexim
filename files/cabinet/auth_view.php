...
<div class="login-container">
    ...
    <form action="/cabinet/auth" method="post">
        <input type="text" id="iin" name="bin" placeholder="БИН" required aria-label="Введите ваш БИН" autocomplete="username">
        
        <input type="password" id="password" name="password" placeholder="Пароль" required aria-label="Введите ваш пароль" autocomplete="current-password">
