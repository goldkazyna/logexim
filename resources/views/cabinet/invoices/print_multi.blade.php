...
<head>
    ...
    <title>Печать накладных ({{ $invoices->count() }})</title>
    <style>
        ...
        .wrapper + .wrapper { page-break-before: always; }
    </style>
</head>

<script src="https://cdn.jsdelivr.net/npm/jsbarcode@3.11.6/dist/JsBarcode.all.min.js"></script>
<body onload="document.querySelectorAll('.barcode-svg').forEach(function(el){JsBarcode(el,el.dataset.value,{displayValue:false,width:2,height:28,margin:0})});window.print()">
    ...
    <div class="invoice">
        <div class="header-new">
            <div class="header-col header-col-left">
                ...
                <svg class="barcode-svg" data-value="{{ $invoice->invoice_number }}"></svg>
                <p class="company-name" style="margin-top:5px">ТОО «LogExim Express» | E-mail: sale@logexim.kz</p>
            ...
            <div class="header-col header-col-right"></div>
        </div>
        <div class="main">
