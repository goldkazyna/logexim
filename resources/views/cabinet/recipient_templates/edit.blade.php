...
<main class="flex-grow p-6">
    ...
    <form action="{{ url('cabinet/update_recipient_template') }}" method="post">
        ...
        <div class="mb-4"><label class="text-gray-800 font-bold text-base inline-block mb-2">Город</label>@include('partials.city-select', ['id' => 'tpl-city', 'name' => 'city', 'selected' => $template->city, 'cities' => $cities])</div>
